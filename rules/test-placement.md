...
- Suite filenames match the suite subject, not the thing being tested at the filename level: `tests/auth/auth.test.js` beats `tests/auth/login-handler.test.js`. The `tests/<suite>/` prefix already provides context.
