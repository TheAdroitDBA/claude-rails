...
1. Start your first feature
   Create <feature-name>.feature.md next to the primary code file. If the feature has a user-facing surface (CLI, UI, API humans call, error message, docs page), write or update a *.flow.md first -- the "Outside-in for user-facing work" principle in the claude-rails MEMORY.md charter.
