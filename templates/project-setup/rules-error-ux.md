...
- Before calling any function that could block the UI: evaluate whether it could exceed 16ms. If yes, show the indicator first, then dispatch the work.
...
- Review unresolved error registry entries as part of regular triage.
